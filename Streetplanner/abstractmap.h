...
public:
    ...
    /**
    /** * @brief Returns City List
    /** * @return List of all City Names in the Map
    */
    virtual QVector<City*> getCityList() const = 0;
    ...
    /**
     * @brief Redraw whole map.
     * @param scene Reference to QGraphicScene
     */
    virtual void draw(QGraphicsScene& scene)const = 0;

    /**
     * @brief Clears map of cities and streets
     */
